<template>
    <div class="register-view isolate bg-white px-6 py-12 sm:py-24 lg:px-8">
        ...
        <form class="mx-auto mt-16 max-w-xl sm:mt-20" @submit.prevent="">
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-2.5">
                        <input type="text" name="username" id="username" autocomplete="organization"
                ...
                <!-- password -->
                <div class="sm:col-span-2">
                    <label for="repassword" class="block text-sm font-semibold leading-6 text-gray-900">Enter Re-Password</label>
                    <div class="mt-2.5">
                        <input type="password" name="repassword" id="repassword" autocomplete="organization"
                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                    </div>
                </div>
